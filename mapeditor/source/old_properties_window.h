...
protected:
	wxSpinCtrl* keynumber_field;
	wxSpinCtrl* doorlevel_field;
	wxSpinCtrl* keyholenumber_field;
	wxSpinCtrl* doorquestnumber_field;
	wxSpinCtrl* doorquestvalue_field;
	wxSpinCtrl* chestquestnumber_field;

	wxSpinCtrl* radius_field;
